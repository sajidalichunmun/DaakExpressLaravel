...
use App\User;
use Auth;
use App\Repositories\PacketTypeBusinessLogic;

class ApiPacketTypeController extends Controller
{
    private $logic;
    public function __construct(PacketTypeBusinessLogic $_logic)
    {
        $this->logic = $_logic;
    }
    /**
