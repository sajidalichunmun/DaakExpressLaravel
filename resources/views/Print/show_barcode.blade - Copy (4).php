                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
                            ...
                            <div class="btn-group btn-group-sm pull-right" role="group">
                                <button type="button" onclick="ExportToExcel('tbExport','Export');" name="btnExport" id="btnExportID" class="btn btn-sm btn-success"  title="Print"><span class="fa fa-print" aria-hidden="true"></span>  Print PDF</button>
                            </div>
                        </div>
