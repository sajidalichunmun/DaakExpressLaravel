...
<div class="panel panel-primary">
    <div class="panel-heading clearfix">
        ...
        <div class="pull-right">
            ...
            {!! Form::open([
                'method' =>'DELETE',
                'route'  => ['ScanOutPod.TranMenu.destroy', $result->AwbNo]
            ]) !!}
                <div class="btn-group btn-group-sm" role="group">
                    ...
                    <a href="{{ route('ScanOutPod.TranMenu.create') }}" class="btn btn-success" title="Create New Out Scanning">
                        <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
                    </a>

                    <a href="{{ route('ScanOutPod.TranMenu.edit', $result->AwbNo ) }}" class="btn btn-primary" title="Edit Out Scanning">
    ...
    <div class="panel-body">
        <dl class="dl-horizontal">
			...
			<dt>Scan Out Date</dt>
            <dd>{{ isset($result->scanout->ScanOutdt) ? $result->scanout->ScanOutdt : '' }}</dd>
			<dt>Delivery Boy Name</dt>
            <dd>{{ isset($result->scanout->Delivery->Name) ? $result->scanout->Delivery->Name : '' }}</dd>
			<dt>Customer Name</dt>
