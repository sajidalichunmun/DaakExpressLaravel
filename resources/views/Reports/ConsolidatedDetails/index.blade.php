...
<!-- SEARCH BUTTON PANEL END -->
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-heading clearfix">
            <div class="pull-left">
                <h4 class="mt-5 mb-5">Consolidated Details</h4>
            </div>
        </div>
		<div class="panel-heading clearfix">
			<form name="frmEntryID" id="frmEntryID" method="get" action="{{ route('consolidateddetails.reports.index') }}" enctype="multipart/form-data">
				@csrf
