...
<!-- SEARCH BUTTON PANEL END -->
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-heading clearfix">
            <div class="pull-left">
                <h4 class="mt-5 mb-5">Export Excel Awb Pending</h4>
            </div>
        </div>
		<div class="panel-heading clearfix">
			<form name="frmEntryID" id="frmEntryID" method="get" action="{{ route('exportexcelawbpending.reports.index') }}" enctype="multipart/form-data">
				@csrf
				...
				<div class="col-sm-3 col-xs-offset-0">
					<div class="form-group">
						...
						<input type="date" class="form-control"  name="fromdate" id="fromdate" value="{{ $fromdt }}">
					</div>
				</div>
				<div class="col-sm-3 col-xs-offset-0">
					<div class="form-group">
						<label for="todate">TO DATE</label>
						<input type="date" class="form-control" name="todate" id="todate" value="{{ $todt }}">
					</div>
				</div>
				<div class="form-group">
