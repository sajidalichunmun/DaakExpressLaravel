...
<!-- SEARCH BUTTON PANEL END -->
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-heading clearfix">
            <div class="pull-left">
                <h4 class="mt-5 mb-5">Pickup Details</h4>
            </div>
        </div>
		<div class="panel-heading clearfix">
			<form name="frmEntryID" id="frmEntryID" method="get" action="{{ route('pickupdetails.reports.index') }}" enctype="multipart/form-data">
				@csrf
