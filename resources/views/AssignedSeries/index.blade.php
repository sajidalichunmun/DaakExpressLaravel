...
<!-- SEARCH PANEL -->
<div class="row">
	<form name="frmSearch" action="{{ route('assigned-series-search') }}" method="get" enctype="mulitpart/form" id="frmSearch">
		<div class="col-sm-11 col-xs-offset-0">
			<div class="form-group">
				<label for="txtSearchID">SEARCH</label>
				<input type="text" name="txtSearchID" value="{{ $find ?? '' }}" id="txtSearchID" placeholder="Enter username" required="true" class="form-control text-capitalize text-justify">
			</div>
...
<!-- SEARCH BUTTON PANEL END -->
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">Assigned Series</h4>
            </div>
            ...
            <div class="btn-group btn-group-sm pull-right" role="group">
				...
				&nbsp;
                <a href="{{ route('AssignedSeries.Mast.create') }}" class="btn btn-success btn-sm mt-3 " title="Create New Assigned Series">
        ...
        @if(count($result) == 0)
            <div class="panel-body text-center">
                <h4>No Assigned Series Available.</h4>
            </div>
        @else
						...
						@foreach($result as $v)
							<tr>
								...
								<td>
									...
									{!! Form::open([
										'method' =>'DELETE',
										'route'  => ['AssignedSeries.Mast.destroy', $v->ID],
										'style'  => 'display: inline;',
									]) !!}
										<div class="btn-group btn-group-xs pull-right" role="group">
											<a href="{{ route('AssignedSeries.Mast.show', $v->ID ) }}" class="btn btn-success" title="Show Assigned Series">
												<span class="fa fa-eye" aria-hidden="true"></span>
											</a>
											<!--a href="{{ route('AssignedSeries.Mast.edit', $v->ID ) }}" class="btn btn-primary" title="Edit Assigned Series">
											...
											{!! Form::button('<span class="fa fa-trash" aria-hidden="true"></span>', 
												[   
													...
													'title'   => 'Delete Assigned Series',
													'onclick' => 'return confirm("' . 'Click Ok to delete Assigned Series.' . '")'
												])
											!!}
										</div>
									{!! Form::close() !!}
