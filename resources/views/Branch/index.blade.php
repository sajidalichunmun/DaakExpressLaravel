...
<!-- SEARCH PANEL -->
<div class="row">
	<form name="frmSearch" action="/packet-type-mast/search" method="get" enctype="mulitpart/form" id="frmSearch">
		<div class="col-sm-11 col-xs-offset-0">
			<div class="form-group">
				<label for="txtSearchID">SEARCH</label>
				<input type="text" name="txtSearchID" id="txtSearchID" required="true" class="form-control text-capitalize text-justify">
			</div>
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-heading clearfix">
			...
			<button type="button" onclick="ExportToExcel('tbExport','Export');" name="btnExport" id="btnExportID" class="btn btn-info btn-sm mt-3"  title="Export Data"> <span class="fa fa-download" aria-hidden="true"></span> Export in Excel</button>
				&nbsp;
                <a href="{{ route('PacketType.Mast.create') }}" class="btn btn-success btn-sm" title="Create New Packet Type">
								...
								<td>
									...
									{!! Form::open([
										...
										<div class="btn-group btn-group-xs pull-right" role="group">
											<a href="{{ route('PacketType.Mast.show', $v->ID ) }}" class="btn btn-success" title="Show SingleInvoice">
												<span class="fa fa-eye" aria-hidden="true"></span>
											</a>
											<a href="{{ route('PacketType.Mast.edit', $v->ID ) }}" class="btn btn-primary" title="Edit SingleInvoice">
