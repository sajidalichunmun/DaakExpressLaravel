...
<div class="panel panel-primary">
    <div class="panel-heading clearfix">
        ...
        <div class="pull-right">
            ...
            {!! Form::open([
                'method' =>'DELETE',
                'route'  => ['Reason.Mast.destroy', $result->ID]
            ]) !!}
                <div class="btn-group btn-group-sm" role="group">
                    ...
                    <a href="{{ route('Reason.Mast.create') }}" class="btn btn-success" title="Create New Reason">
                        <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
                    </a>

                    <a href="{{ route('Reason.Mast.edit', $result->ID ) }}" class="btn btn-primary" title="Edit Reason">
