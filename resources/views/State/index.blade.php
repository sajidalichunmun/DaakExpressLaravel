...
<!-- SEARCH PANEL -->
<div class="row">
	<form name="frmSearch" action="{{ route('state_search') }}" method="get" enctype="mulitpart/form" id="frmSearch">
		<div class="col-sm-11 col-xs-offset-0">
			<div class="form-group">
				<label for="txtSearchID">SEARCH</label>
				<input type="text" name="txtSearchID" value="{{ $find ?? ''}}" id="txtSearchID" placeholder="Enter state name" required="true" class="form-control text-capitalize text-justify">
			</div>
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="btn-group btn-group-sm pull-right" role="group">
                ...
                <a href="{{ route('State.Mast.create') }}" class="btn btn-success btn-sm" title="Create New State">
						...
						@foreach($result as $v)
							<tr>
								...
								<td>
									...
									{!! Form::open([
										'method' =>'DELETE',
										'route'  => ['State.Mast.destroy', $v->ID],
										'style'  => 'display: inline;',
									]) !!}
										<div class="btn-group btn-group-xs pull-right" role="group">
											<a href="{{ route('State.Mast.show', $v->ID ) }}" class="btn btn-success" title="Show State">
												<span class="fa fa-eye" aria-hidden="true"></span>
											</a>
											<a href="{{ route('State.Mast.edit', $v->ID ) }}" class="btn btn-primary" title="Edit State">
