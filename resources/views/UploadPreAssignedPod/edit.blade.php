    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="btn-group btn-group-sm pull-right" role="group">
                ...
                <a href="{{ route('UploadPreAssignedPod.TranMenu.create') }}" class="btn btn-primary" title="Create New Upload Data">
        ...
        <div class="panel-body">
            ...
            {!! Form::model($result, [
                'method' => 'PUT',
                'route' => ['UploadPreAssignedPod.TranMenu.update', $result->ID],
            ...
            @include ('UploadPreAssignedPod.form', ['result' => $result,])
