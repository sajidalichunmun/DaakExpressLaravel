            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav">
                        <li><a href="{{ route('About') }}" :active="request()->routeIs('About')" >About us</a></li>
                        <li><a href="{{ route('Contact') }}" :active="request()->routeIs('Contact')">Contact us</a></li>
                        <li><a href="{{ route('Service') }}" :active="request()->routeIs('Service')">Service's</a></li>
					</ul>
