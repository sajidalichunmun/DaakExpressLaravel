    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="btn-group btn-group-sm pull-right" role="group">
                ...
                <a href="{{ route('Franchisee.Mast.create') }}" class="btn btn-primary" title="Create New Franchisee">
        ...
        <div class="panel-body">
            ...
            {!! Form::model($result, [
                'method' => 'PUT',
                'route' => ['Franchisee.Mast.update', $result->ID],
            ...
            @include ('Franchisee.form', ['result' => $result,])
