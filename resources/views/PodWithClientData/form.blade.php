<div class="row">
	...
	<div class="col-md-2">
		<div class="form-group {{ $errors->has('clientexceldataid') ? 'has-error' : '' }}">
		{!! Form::label('clientexceldataid','ID',) !!}
			{!! Form::text('clientexceldataid', null, ['class' => 'form-control', 'readonly' => true, 'required' => true, 'placeholder' =>'Enter Client Code ID','title' => 'Client Code ID']) !!}
			{!! $errors->first('clientexceldataid', '<p class="help-block">:message</p>') !!}
		</div>
	</div>
...
<div class="row">
	...
	<div class="col-sm-2">
		...
		{!! Form::label('RefNo','REF NO',) !!}
			{!! Form::text('RefNo', isset($result) ? $result->RefNo : null, ['class' => 'form-control', 'minlength' => '1', 'maxlength' => '150', 'required' => true, 'placeholder' =>'Enter Reference No','title' => 'Reference No']) !!}
			{!! $errors->first('RefNo', '<p class="help-block">:message</p>') !!}
		</div>
	</div>
	<div class="col-sm-2">
		<div class="form-group {{ $errors->has('BarcodeNo') ? 'has-error' : '' }}">
		{!! Form::label('BarcodeNo','BAR CODE',) !!}
			{!! Form::text('BarcodeNo', isset($result) ? $result->BarcodeNo : null, ['class' => 'form-control', 'minlength' => '1', 'maxlength' => '150', 'required' => true, 'placeholder' =>'Enter Barcode No','title' => 'Bar Code']) !!}
			{!! $errors->first('BarcodeNo', '<p class="help-block">:message</p>') !!}
		</div>
	</div>
	<div class="col-sm-3">
