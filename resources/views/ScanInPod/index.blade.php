...
<!-- SEARCH BUTTON PANEL END -->
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">In Scanning</h4>
            </div>
            ...
            <div class="btn-group btn-group-sm pull-right" role="group">
                ...
                <a href="{{ route('ScanInPod.TranMenu.create') }}" class="btn btn-success btn-sm" title="Create New In Scanning">
        ...
        @if(count($result) == 0)
            <div class="panel-body text-center">
                <h4>No In Scanning Available.</h4>
            </div>
        @else
					...
					<table class="table table-striped" id="tbExport">
						...
						@foreach($result as $v)
							<tr>
								...
								<td>{{ isset($v->scanin->ScanIndt) ? $v->scanin->ScanIndt : '' }}</td>
								<td>{{ isset($v->MobileNo) ? $v->MobileNo : '' }}</td>
								...
								<td>
									...
									{!! Form::open([
										'method' =>'DELETE',
										'route'  => ['ScanInPod.TranMenu.destroy', $v->AwbNo],
										'style'  => 'display: inline;',
									]) !!}
										<div class="btn-group btn-group-xs pull-right" role="group">
											<a href="{{ route('ScanInPod.TranMenu.show', $v->AwbNo ) }}" class="btn btn-success" title="Show In Scanning">
												<span class="fa fa-eye" aria-hidden="true"></span>
											</a>
											<a href="{{ route('ScanInPod.TranMenu.edit', $v->AwbNo ) }}" class="btn btn-primary" title="Edit In Scanning">
