...
<!-- SEARCH PANEL -->
<div class="row">
	<form name="frmSearch" action="{{ route('fran-rate-search') }}" method="get" enctype="mulitpart/form" id="frmSearch">
...
<!-- SEARCH BUTTON PANEL END -->
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">Franchisee Rate</h4>
            </div>
			...
			<button type="button" onclick="ExportToExcel('tbExport','Export');" name="btnExport" id="btnExportID" class="btn btn-info btn-sm mt-3"  title="Export Data"> <span class="fa fa-download" aria-hidden="true"></span> Export in Excel</button>
				&nbsp;
                <a href="{{ route('FranchiseeRate.Mast.create') }}" class="btn btn-success btn-sm" title="Create New Franchisee Rate">
        ...
        @if(count($result) == 0)
            <div class="panel-body text-center">
                <h4>No Franchisee Rate Available.</h4>
            </div>
        @else
						...
						@foreach($result as $v)
							<tr>
								...
								<td>
									...
									{!! Form::open([
										'method' =>'DELETE',
										'route'  => ['FranchiseeRate.Mast.destroy', $v->ID],
										'style'  => 'display: inline;',
									]) !!}
										<div class="btn-group btn-group-xs pull-right" role="group">
											<a href="{{ route('FranchiseeRate.Mast.show', $v->ID ) }}" class="btn btn-success" title="Show Franchisee Rate">
												<span class="fa fa-eye" aria-hidden="true"></span>
											</a>
											<a href="{{ route('FranchiseeRate.Mast.edit', $v->ID ) }}" class="btn btn-primary" title="Edit Franchisee Rate">
