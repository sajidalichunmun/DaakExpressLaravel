	...
	<form name="frmSearch" action="{{ route('uploadstate_search') }}h" method="get" enctype="mulitpart/form" id="frmSearch">
		<div class="col-sm-11 col-xs-offset-0">
			<div class="form-group">
				...
				<input type="text" name="txtSearchID"value="{{ $find ?? '' }}" placeholder="Enter state name" id="txtSearchID" required="true" class="form-control text-capitalize text-justify">
			</div>
...
<!-- SEARCH BUTTON PANEL END -->
    <div class="panel panel-primary">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">UPLOAD STATE FROM EXCEL FILE</h4>
            </div>
			
            <div class="btn-group btn-group-sm pull-right" role="group">
				<button class="btn btn-danger pull-right delete_all" data-url="{{ route('delivery_rto_deleteAll') }}"><span class="fa fa-trash" aria-hidden="true"></span> Delete All Selected</button>
                ...
                <a href="{{ route('uploadstate.TranMenu.create') }}" class="btn btn-success btn-sm" title="Create New Client Data">
						...
						@foreach($result as $v)
							<tr>
								...
								<td>
									...
									{!! Form::open([
										'method' =>'DELETE',
										'route'  => ['uploadstate.TranMenu.destroy', $v->ID],
										'style'  => 'display: inline;',
									]) !!}
										<div class="btn-group btn-group-xs pull-right" role="group">
											<a href="{{ route('uploadstate.TranMenu.show', $v->ID ) }}" class="btn btn-success" title="Show Client Data">
												<span class="fa fa-eye" aria-hidden="true"></span>
											</a>
											<!--a href="{{ route('uploadstate.TranMenu.edit', $v->ID ) }}" class="btn btn-primary" title="Edit Client Data">
