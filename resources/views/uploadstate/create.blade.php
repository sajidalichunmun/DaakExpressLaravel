...
@section('content')
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">UPDATE STATE FROM EXCEL FILE</h4>
            </div>
        ...
        <div class="panel-body">
            ...
            <form name="frmEntryID" id="frmEntryID" method="post" action="{{ route('uploadstate.TranMenu.store') }}" enctype="multipart/form-data">
					@csrf
						 <div class="row">
							<div class="col-sm-12">
