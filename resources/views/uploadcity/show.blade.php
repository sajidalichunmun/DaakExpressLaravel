...
<div class="panel panel-primary">
    <div class="panel-heading clearfix">
        ...
        <div class="pull-right">
            ...
            {!! Form::open([
                'method' =>'DELETE',
                'route'  => ['uploadcity.TranMenu.destroy', $result->ID]
            ]) !!}
                <div class="btn-group btn-group-sm" role="group">
                    <a href="{{ route('uploadcity.TranMenu.index') }}" class="btn btn-primary" title="Show All Client Data">
                        <span class="glyphicon glyphicon-th-list" aria-hidden="true"></span>
                    </a>

                    <a href="{{ route('uploadcity.TranMenu.create') }}" class="btn btn-success" title="Create New Client Data">
                        <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
                    </a>

                    <!--a href="{{ route('uploadcity.TranMenu.edit', $result->ID ) }}" class="btn btn-primary" title="Edit Client Data">
