...
<!-- SEARCH PANEL -->
<div class="row">
	<form name="frmSearch" action="{{ route('uploadcity_search') }}" method="get" enctype="mulitpart/form" id="frmSearch">
...
<!-- SEARCH BUTTON PANEL END -->
    <div class="panel panel-primary">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">UPDATE CITY FROM EXCEL FILE</h4>
            </div>
			
            <div class="btn-group btn-group-sm pull-right" role="group">
				<button class="btn btn-danger pull-right delete_all" data-url="{{ route('uploadcity_deleteAll') }}"><span class="fa fa-trash" aria-hidden="true"></span> Delete All Selected</button>
                ...
                <a href="{{ route('uploadcity.TranMenu.create') }}" class="btn btn-success btn-sm" title="Create New Client Data">
						...
						@foreach($result as $v)
							<tr>
								...
								<td>
									...
									{!! Form::open([
										'method' =>'DELETE',
										'route'  => ['uploadcity.TranMenu.destroy', $v->ID],
										'style'  => 'display: inline;',
									]) !!}
										<div class="btn-group btn-group-xs pull-right" role="group">
											<a href="{{ route('uploadcity.TranMenu.show', $v->ID ) }}" class="btn btn-success" title="Show Client Data">
												<span class="fa fa-eye" aria-hidden="true"></span>
											</a>
											<!--a href="{{ route('uploadcity.TranMenu.edit', $v->ID ) }}" class="btn btn-primary" title="Edit Client Data">
