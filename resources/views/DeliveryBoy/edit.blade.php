    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="btn-group btn-group-sm pull-right" role="group">
                ...
                <a href="{{ route('DeliveryBoy.Mast.create') }}" class="btn btn-primary" title="Create New Delivery Boy">
        ...
        <div class="panel-body">
            ...
            {!! Form::model($result, [
                'method' => 'PUT',
                'route' => ['DeliveryBoy.Mast.update', $result->ID],
            ...
            @include ('DeliveryBoy.form', ['result' => $result,])
