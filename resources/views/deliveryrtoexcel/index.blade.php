...
<!-- SEARCH PANEL -->
<div class="row">
	<form name="frmSearch" action="{{ route('deliveryrtoexcel-search') }}" method="get" enctype="mulitpart/form" id="frmSearch">
...
<!-- SEARCH BUTTON PANEL END -->
    <div class="panel panel-primary">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">UPDATE DELIVERY/RTO FROM EXCEL FILE</h4>
            </div>
            ...
            <div class="btn-group btn-group-sm pull-right" role="group">
                ...
                <a href="{{ route('deliveryrtoexcel.TranMenu.create') }}" class="btn btn-success btn-sm" title="Create New Client Data">
						...
						@foreach($result as $v)
							<tr>
								...
								<td>
									...
									{!! Form::open([
										'method' =>'DELETE',
										'route'  => ['deliveryrtoexcel.TranMenu.destroy', $v->id],
										'style'  => 'display: inline;',
									]) !!}
										<div class="btn-group btn-group-xs pull-right" role="group">
											<a href="{{ route('deliveryrtoexcel.TranMenu.show', $v->id ) }}" class="btn btn-success" title="Show Client Data">
												<span class="fa fa-eye" aria-hidden="true"></span>
											</a>
											<!--a href="{{ route('deliveryrtoexcel.TranMenu.edit', $v->id ) }}" class="btn btn-primary" title="Edit Client Data">
