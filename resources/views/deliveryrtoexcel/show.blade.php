...
<div class="panel panel-primary">
    <div class="panel-heading clearfix">
        ...
        <div class="pull-right">
            ...
            {!! Form::open([
                'method' =>'DELETE',
                'route'  => ['deliveryrtoexcel.TranMenu.destroy', $result->id]
            ]) !!}
                <div class="btn-group btn-group-sm" role="group">
                    ...
                    <a href="{{ route('deliveryrtoexcel.TranMenu.create') }}" class="btn btn-success" title="Create New Client Data">
                        <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
                    </a>

                    <!--a href="{{ route('deliveryrtoexcel.TranMenu.edit', $result->id ) }}" class="btn btn-primary" title="Edit Client Data">
