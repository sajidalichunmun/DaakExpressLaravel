...
<!-- SEARCH PANEL -->
<div class="row">
	<form name="frmSearch" action="{{ route('subare_search') }}" method="get" enctype="mulitpart/form" id="frmSearch">
		<div class="col-sm-11 col-xs-offset-0">
			<div class="form-group">
				<label for="txtSearchID">SEARCH</label>
				<input type="text" name="txtSearchID" value="{{ $find ?? '' }}" placeholder="Enter area name" id="txtSearchID" required="true" class="form-control text-capitalize text-justify">
			</div>
...
<!-- SEARCH BUTTON PANEL END -->
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">Sub Area</h4>
            </div>
            ...
            <div class="btn-group btn-group-sm pull-right" role="group">
                ...
                <a href="{{ route('SubArea.Mast.create') }}" class="btn btn-success btn-sm" title="Create New Sub Area">
						...
						@foreach($result as $v)
							<tr>
								...
								<td>
									...
									{!! Form::open([
										'method' =>'DELETE',
										'route'  => ['SubArea.Mast.destroy', $v->ID],
										'style'  => 'display: inline;',
									]) !!}
										<div class="btn-group btn-group-xs pull-right" role="group">
											<a href="{{ route('SubArea.Mast.show', $v->ID ) }}" class="btn btn-success" title="Show Sub Area">
												<span class="fa fa-eye" aria-hidden="true"></span>
											</a>
											<a href="{{ route('SubArea.Mast.edit', $v->ID ) }}" class="btn btn-primary" title="Edit Sub Area">
