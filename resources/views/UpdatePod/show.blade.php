...
<div class="panel panel-primary">
    <div class="panel-heading clearfix">
        ...
        <div class="pull-right">
            ...
            {!! Form::open([
                'method' =>'DELETE',
                'route'  => ['UpdatePod.TranMenu.destroy', $result->AwbNo]
            ]) !!}
                <div class="btn-group btn-group-sm" role="group">
                    ...
                    <a href="{{ route('UpdatePod.TranMenu.create') }}" class="btn btn-success" title="Create New Delivery">
                        <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
                    </a>

                    <a href="{{ route('UpdatePod.TranMenu.edit', $result->AwbNo ) }}" class="btn btn-primary" title="Edit Delivery">
