...
<div class="panel panel-primary">
    <div class="panel-heading clearfix">
        ...
        <div class="pull-right">
            ...
            {!! Form::open([
                'method' =>'DELETE',
                'route'  => ['MannualPod.TranMenu.destroy', $result->AwbNo]
            ]) !!}
                <div class="btn-group btn-group-sm" role="group">
                    ...
                    <a href="{{ route('MannualPod.TranMenu.create') }}" class="btn btn-success" title="Create New Mannual POD">
                        <span class="glyphicon glyphicon-plus" aria-hAwbNoden="true"></span>
                    </a>

                    <a href="{{ route('MannualPod.TranMenu.edit', $result->AwbNo ) }}" class="btn btn-primary" title="Edit Mannual POD">
