    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="btn-group btn-group-sm pull-right" role="group">
                ...
                <a href="{{ route('ClientRate.Mast.create') }}" class="btn btn-primary" title="Create New Client Rate">
        ...
        <div class="panel-body">
            ...
            {!! Form::model($result, [
                'method' => 'PUT',
                'route' => ['ClientRate.Mast.update', $result->ID],
            ...
            @include ('ClientRate.form', ['result' => $result,])
