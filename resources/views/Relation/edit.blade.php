    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="btn-group btn-group-sm pull-right" role="group">
                ...
                <a href="{{ route('Relation.Mast.create') }}" class="btn btn-primary" title="Create New Relation">
        ...
        <div class="panel-body">
            ...
            {!! Form::model($result, [
                'method' => 'PUT',
                'route' => ['Relation.Mast.update', $result->ID],
            ...
            @include ('Relation.form', ['result' => $result,])
