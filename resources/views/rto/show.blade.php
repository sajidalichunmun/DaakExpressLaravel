...
<div class="panel panel-primary">
    <div class="panel-heading clearfix">
        ...
        <div class="pull-right">
            ...
            {!! Form::open([
                'method' =>'DELETE',
                'route'  => ['rto.TranMenu.destroy', $result->AwbNo]
            ]) !!}
                <div class="btn-group btn-group-sm" role="group">
                    <a href="{{ route('rto.TranMenu.index') }}" class="btn btn-primary" title="Show All RTO">
                        <span class="glyphicon glyphicon-th-list" aria-hidden="true"></span>
                    </a>

                    <a href="{{ route('rto.TranMenu.create') }}" class="btn btn-success" title="Create New RTO">
                        <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
                    </a>

                    <a href="{{ route('rto.TranMenu.edit', $result->AwbNo ) }}" class="btn btn-primary" title="Edit RTO">
