...
<!-- SEARCH PANEL -->
<div class="row">
	<form name="frmSearch" action="{{ route('tran-rto-status-search') }}" method="get" enctype="mulitpart/form" id="frmSearch">
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="btn-group btn-group-sm pull-right" role="group">
                ...
                <a href="{{ route('rto.TranMenu.create') }}" class="btn btn-success btn-sm" title="Create New RTO">
						...
						@foreach($result as $v)
							<tr>
								...
								<td>
									...
									{!! Form::open([
										'method' =>'DELETE',
										'route'  => ['rto.TranMenu.destroy', $v->AwbNo],
										'style'  => 'display: inline;',
									]) !!}
										<div class="btn-group btn-group-xs pull-right" role="group">
											<a href="{{ route('rto.TranMenu.show', $v->AwbNo ) }}" class="btn btn-success" title="Show RTO">
												<span class="fa fa-eye" aria-hidden="true"></span>
											</a>
											<a href="{{ route('rto.TranMenu.edit', $v->AwbNo ) }}" class="btn btn-primary" title="Edit RTO">
											...
											{!! Form::button('<span class="fa fa-trash" aria-hidden="true"></span>', 
												[   
													...
													'title'   => 'Delete RTO',
													'onclick' => 'return confirm("' . 'Click Ok to delete RTO.' . '")'
												])
											!!}
										</div>
									{!! Form::close() !!}
