...
<!-- SEARCH BUTTON PANEL END -->
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">Manifest Bulk</h4>
            </div>
			...
			<button type="button" onclick="ExportToExcel('tbExport','Export');" name="btnExport" id="btnExportID" class="btn btn-info btn-sm mt-3"  title="Export Data"> <span class="fa fa-download" aria-hidden="true"></span> Export in Excel</button>
				&nbsp;
                <a href="{{ route('ManifestBulk.TranMenu.create') }}" class="btn btn-success btn-sm" title="Create New Manifest Bulk">
        ...
        @if(count($result) == 0)
            <div class="panel-body text-center">
                <h4>No Manifest Bulk Available.</h4>
            </div>
        @else
						...
						@foreach($result as $v)
							<tr>
								...
								<td>
									...
									{!! Form::open([
										'method' =>'DELETE',
										'route'  => ['ManifestBulk.TranMenu.destroy', $v->AwbNo],
										'style'  => 'display: inline;',
									]) !!}
										<div class="btn-group btn-group-xs pull-right" role="group">
											<a href="{{ route('ManifestBulk.TranMenu.show', $v->AwbNo ) }}" class="btn btn-success" title="Show Manifest Bulk">
												<span class="fa fa-eye" aria-hidden="true"></span>
											</a>
											<!-- <a href="{{ route('ManifestBulk.TranMenu.edit', $v->AwbNo ) }}" class="btn btn-primary" title="Edit Manifest Bulk">
